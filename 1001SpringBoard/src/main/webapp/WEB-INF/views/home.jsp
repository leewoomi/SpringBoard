	...
	<div>
		...
		<div class="box-header with-border">
			<c:if test="${user==null}">
				...
				<a href="${pageContext.request.contextPath}/board/list"><h3
						class="box-title">목록보기</h3></a>
		...
		<div class="box-header with-border">
			<c:if test="${user!=null }">
				...
				<a href="${pageContext.request.contextPath}/user/userDelete"><h3
						class="box-title">회원 탈퇴</h3></a>
				<a href="${pageContext.request.contextPath}/user/mypage"><h3
						class="box-title">마이페이지</h3></a>
